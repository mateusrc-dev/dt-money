...
export const SummaryContainer = styled.section`
  ...
  grid-template-columns: repeat(
    3,
    1fr
  ); // vamos querer três colunas dentro do grid todas do mesmo tamanho
  gap: 2rem; // espaçamento entre colunas
  margin-top: -5rem; // isso é para que o componente atravesse o header acima
`

interface SummaryCardProps {
  // vamos definir que o componente SumarryCard pode receber uma propriedade chamada variant
