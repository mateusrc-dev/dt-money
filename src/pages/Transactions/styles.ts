...
export const TransactionsTable = styled.table` // novamente criando componentes e evitando cascatas
  width: 100%;
  ...
  td {
    ...
    &:first-child { // vamos estilizar a primeira td de cada linha para colocar um border radius nos cantos
      border-top-left-radius: 6px;
      border-bottom-left-radius: 6px;
    }

    &:last-child { // vamos estilizar o último td de cada linha para colocar um border radius nos cantos
...
interface PriceHighLightProps { // vamos passar uma propriedade indicando se vai ser uma entrada ou saída
